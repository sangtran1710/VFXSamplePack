...
Each exposed MCP tool includes simple grouping plus routing metadata in UE5.7: `tool_group`, `unreal_domain`, `workflow_lane`, `surface_area`, `primary_lane`, `vfx_affinity`, and `capability_tags`.
