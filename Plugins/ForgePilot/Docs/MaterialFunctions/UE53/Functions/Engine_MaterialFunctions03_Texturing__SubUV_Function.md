...
Allows SubUV blending of multiple texture frames in a single texture
...
- `B` <= [7] Input UVs (Vector2) output 0
...
- [7] Input UVs (Vector2) output 0 -> Add.B
- [7] Input UVs (Vector2) output 0 -> Add.A
...
- [10] Frac output 0 -> Lerp.Alpha
- [7] Input UVs (Vector2) output 0 -> Output UVs.A

## Output Trace Roots

- `RGB` is driven by [28] Lerp
- `Alpha` is driven by [30] Lerp
- `UVs` is driven by [7] Input UVs (Vector2)
