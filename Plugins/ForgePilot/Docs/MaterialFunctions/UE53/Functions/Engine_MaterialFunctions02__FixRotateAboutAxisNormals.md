...
- `PivotPoint` [FunctionInput_Vector3]
...
| 17 | function_input | `MaterialExpressionFunctionInput` | Input PivotPoint (Vector3) | PivotPoint |
...
- `PivotPoint` <= [17] Input PivotPoint (Vector3) output 0
...
### [17] Input PivotPoint (Vector3)

- `Preview` <= [3] 0 output 0
...
- [17] Input PivotPoint (Vector3) output 0 -> RotateAboutAxis.PivotPoint
...
- [3] 0 output 0 -> Input PivotPoint (Vector3).Preview
