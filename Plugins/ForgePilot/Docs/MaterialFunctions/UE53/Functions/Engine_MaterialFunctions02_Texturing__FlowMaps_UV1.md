...
| 6 | expression | `MaterialExpressionTextureCoordinate` | TexCoord[1] |  |
...
| 68 | expression | `MaterialExpressionTextureCoordinate` | TexCoord[1] |  |
...
- [6] TexCoord[1] output 0 -> Input UVs (Vector2).Preview
