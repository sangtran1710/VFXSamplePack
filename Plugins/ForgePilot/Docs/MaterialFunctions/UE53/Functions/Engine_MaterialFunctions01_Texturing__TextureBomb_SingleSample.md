...
- `Normal Flip` - This contains the flipping factor for normal maps. XY is the flip, Z is the swizzle mask. Only used for Parallax Occlusion Mapping
...
| 50 | function_output | `MaterialExpressionFunctionOutput` | Output Tangent Space Camera Vector | Tangent Space Camera Vector |
| 51 | function_call | `MaterialExpressionMaterialFunctionCall` | ParallaxOcclusionMapping |  |
| 52 | expression | `MaterialExpressionTransform` | World Space to Tangent Space TransformVector |  |
| 53 | function_call | `MaterialExpressionMaterialFunctionCall` | Sprite |  |
| 54 | function_output | `MaterialExpressionFunctionOutput` | Output Normal Flip | Normal Flip |
| 55 | expression | `MaterialExpressionAppendVector` | Append |  |
| 56 | expression | `MaterialExpressionCameraVectorWS` | Camera Vector |  |
...
- `A` <= [30] Append output 0
- `B` <= [52] World Space to Tangent Space TransformVector output 0
...
### [50] Output Tangent Space Camera Vector

- `A` <= [49] Lerp output 0

### [52] World Space to Tangent Space TransformVector

- `Input` <= [56] Camera Vector output 0

### [54] Output Normal Flip

- `A` <= [55] Append output 0
...
- [14] Add output 0 -> Texture Sample.Coordinates
...
- [30] Append output 0 -> Multiply.A
- [52] World Space to Tangent Space TransformVector output 0 -> Multiply.B
- [48] Swizzle output 0 -> Lerp.A
- [47] Multiply output 0 -> Lerp.B
- [6] Mask ( R ) output 0 -> Lerp.Alpha
- [49] Lerp output 0 -> Output Tangent Space Camera Vector.A
- [56] Camera Vector output 0 -> World Space to Tangent Space TransformVector.Input
- [55] Append output 0 -> Output Normal Flip.A
- [33] Lerp output 0 -> Append.A
- [6] Mask ( R ) output 0 -> Append.B

## Output Trace Roots

- `UVs` is driven by [14] Add
- `Texture Sample` is driven by [29] Switch
- `Tangent Space Camera Vector` is driven by [49] Lerp
- `Normal Flip` is driven by [55] Append
