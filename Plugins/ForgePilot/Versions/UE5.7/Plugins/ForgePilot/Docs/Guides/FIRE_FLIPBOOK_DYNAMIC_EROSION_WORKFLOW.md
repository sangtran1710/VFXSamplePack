...
Use this workflow when building UE5.7 fire flipbooks where Niagara `Scale Color Alpha` is unreliable, too opaque for debugging, or not friendly enough for AI-generated emitters.
