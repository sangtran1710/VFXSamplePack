...
| 4 | function_input | `MaterialExpressionFunctionInput` | Input NewOpacityMask (Scalar) | NewOpacityMask |
...
- `B` <= [4] Input NewOpacityMask (Scalar) output 0
...
- [4] Input NewOpacityMask (Scalar) output 0 -> Lerp.B
