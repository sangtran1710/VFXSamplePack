...
| 52 | function_call | `MaterialExpressionMaterialFunctionCall` | TextureBomb_SingleSample |  |
...
| 69 | function_call | `MaterialExpressionMaterialFunctionCall` | TextureBomb_SingleSample |  |
| 70 | function_call | `MaterialExpressionMaterialFunctionCall` | TextureBomb_SingleSample |  |
| 71 | function_call | `MaterialExpressionMaterialFunctionCall` | TextureBomb_SingleSample |  |
...
| 82 | function_call | `MaterialExpressionMaterialFunctionCall` | ScaleUVsByCenter |  |
| 83 | expression | `MaterialExpressionScalarParameter` | Param (0) 'Param' |  |
| 84 | expression | `MaterialExpressionAdd` | Add |  |
| 85 | expression | `MaterialExpressionVectorParameter` | Param (0,0,0,0) 't' |  |
| 86 | expression | `MaterialExpressionComponentMask` | Mask ( R G ) |  |
| 87 | expression | `MaterialExpressionStaticComponentMaskParameter` | Mask Param 'Heightmap Channel' |  |
| 88 | expression | `MaterialExpressionAppendVector` | Append |  |
| 89 | expression | `MaterialExpressionAppendVector` | Append |  |
| 90 | expression | `MaterialExpressionStaticComponentMaskParameter` | Mask Param 'Heightmap Channel' |  |
| 91 | expression | `MaterialExpressionAppendVector` | Append |  |
| 92 | expression | `MaterialExpressionStaticComponentMaskParameter` | Mask Param 'Heightmap Channel' |  |
...
- `Coordinates` <= [52] TextureBomb_SingleSample output 0
...
- `A` <= [52] TextureBomb_SingleSample output 2

### [38] Texture Sample

- `Coordinates` <= [71] TextureBomb_SingleSample output 0
- `TextureObject` <= [27] Input Optional Heightmap (Texture2D) output 0
- `CoordinatesDX` <= [72] DDX output 0
- `CoordinatesDY` <= [73] DDY output 0
...
- `A` <= [69] TextureBomb_SingleSample output 2

### [41] Multiply(,1)

- `A` <= [70] TextureBomb_SingleSample output 2

### [42] Texture Sample

- `Coordinates` <= [69] TextureBomb_SingleSample output 0
- `TextureObject` <= [27] Input Optional Heightmap (Texture2D) output 0
- `CoordinatesDX` <= [72] DDX output 0
- `CoordinatesDY` <= [73] DDY output 0
...
- `A` <= [71] TextureBomb_SingleSample output 2
...
- `A` <= [15] Multiply output 0
- `B` <= [86] Mask ( R G ) output 0

### [86] Mask ( R G )

- `Input` <= [85] Param (0,0,0,0) 't' output 0

### [87] Mask Param 'Heightmap Channel'
...
- `B` <= [26] Texture Sample output 4

### [90] Mask Param 'Heightmap Channel'

- `Input` <= [89] Append output 0

### [91] Append

- `A` <= [42] Texture Sample output 0
- `B` <= [42] Texture Sample output 4

### [92] Mask Param 'Heightmap Channel'

- `Input` <= [91] Append output 0
...
- [52] TextureBomb_SingleSample output 0 -> Texture Sample.Coordinates
...
- [52] TextureBomb_SingleSample output 2 -> Multiply(,1).A
- [71] TextureBomb_SingleSample output 0 -> Texture Sample.Coordinates
- [27] Input Optional Heightmap (Texture2D) output 0 -> Texture Sample.TextureObject
- [72] DDX output 0 -> Texture Sample.CoordinatesDX
- [73] DDY output 0 -> Texture Sample.CoordinatesDY
- [69] TextureBomb_SingleSample output 2 -> Multiply(,1).A
- [70] TextureBomb_SingleSample output 2 -> Multiply(,1).A
- [69] TextureBomb_SingleSample output 0 -> Texture Sample.Coordinates
- [27] Input Optional Heightmap (Texture2D) output 0 -> Texture Sample.TextureObject
- [72] DDX output 0 -> Texture Sample.CoordinatesDX
- [73] DDY output 0 -> Texture Sample.CoordinatesDY
...
- [35] Input Enable Height Lerp (StaticBool) output 0 -> Switch.Value
- [71] TextureBomb_SingleSample output 2 -> Multiply(,1).A
- [81] Static Bool (False) output 0 -> Input Is Normalmap (StaticBool).Preview
- [15] Multiply output 0 -> Add.A
- [86] Mask ( R G ) output 0 -> Add.B
- [85] Param (0,0,0,0) 't' output 0 -> Mask ( R G ).Input
- [88] Append output 0 -> Mask Param 'Heightmap Channel'.Input
- [38] Texture Sample output 0 -> Append.A
- [38] Texture Sample output 4 -> Append.B
- [26] Texture Sample output 0 -> Append.A
- [26] Texture Sample output 4 -> Append.B
- [89] Append output 0 -> Mask Param 'Heightmap Channel'.Input
- [42] Texture Sample output 0 -> Append.A
- [42] Texture Sample output 4 -> Append.B
- [91] Append output 0 -> Mask Param 'Heightmap Channel'.Input
