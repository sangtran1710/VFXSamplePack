...
Subtracts the Blend from the Base, Abs the results to ensure the results are positive.
...
- [6] Abs output 0 -> Output Result.A
- [3] Texture Sample output 0 -> Input Base (Vector3).Preview
- [4] Texture Sample output 0 -> Input Blend (Vector3).Preview
- [1] Input Base (Vector3) output 0 -> Subtract.A
- [2] Input Blend (Vector3) output 0 -> Subtract.B
- [5] Subtract output 0 -> Abs.Input

## Output Trace Roots

- `Result` is driven by [6] Abs
