...
- `1` [FunctionInput_Vector3]
- `2` [FunctionInput_Vector3]
- `3` [FunctionInput_Vector3]
- `4` [FunctionInput_Vector3]
...
| 3 | function_input | `MaterialExpressionFunctionInput` | Input 1 (Vector3) | 1 |
| 4 | function_input | `MaterialExpressionFunctionInput` | Input 2 (Vector3) | 2 |
| 5 | function_input | `MaterialExpressionFunctionInput` | Input 3 (Vector3) | 3 |
| 6 | function_input | `MaterialExpressionFunctionInput` | Input 4 (Vector3) | 4 |
...
- `A` <= [3] Input 1 (Vector3) output 0
- `B` <= [4] Input 2 (Vector3) output 0
- `Alpha` <= [9] Clamp output 0

### [2] Lerp

- `A` <= [1] Lerp output 0
- `B` <= [5] Input 3 (Vector3) output 0
...
- [3] Input 1 (Vector3) output 0 -> Lerp.A
- [4] Input 2 (Vector3) output 0 -> Lerp.B
- [9] Clamp output 0 -> Lerp.Alpha
- [1] Lerp output 0 -> Lerp.A
- [5] Input 3 (Vector3) output 0 -> Lerp.B
...
- [6] Input 4 (Vector3) output 0 -> Lerp.B
