...
| 5 | function_input | `MaterialExpressionFunctionInput` | Input Value (Vector4) | Value |
| 6 | function_input | `MaterialExpressionFunctionInput` | Input Wrap (Vector4) | Wrap |
...
- `A` <= [6] Input Wrap (Vector4) output 0
- `B` <= [3] Floor output 0

### [2] Divide

- `A` <= [5] Input Value (Vector4) output 0
- `B` <= [6] Input Wrap (Vector4) output 0
...
- [6] Input Wrap (Vector4) output 0 -> Multiply.A
- [3] Floor output 0 -> Multiply.B
- [5] Input Value (Vector4) output 0 -> Divide.A
- [6] Input Wrap (Vector4) output 0 -> Divide.B
- [2] Divide output 0 -> Floor.Input
- [5] Input Value (Vector4) output 0 -> Subtract.A
