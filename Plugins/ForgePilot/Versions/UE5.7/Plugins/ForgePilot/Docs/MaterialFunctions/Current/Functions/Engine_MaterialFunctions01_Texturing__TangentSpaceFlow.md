...
- `Export Float 4` [FunctionInput_StaticBool] - If set to true the output will exports the texture alpha as well as the Flow textures RGB values.
...
| 41 | expression | `MaterialExpressionStaticBool` | Static Bool (False) |  |
| 42 | function_input | `MaterialExpressionFunctionInput` | Input Export Float 4 (StaticBool) | Export Float 4 |
...
- `B` <= [36] Texture Sample output 0
- `Value` <= [42] Input Export Float 4 (StaticBool) output 0

### [42] Input Export Float 4 (StaticBool)

- `Preview` <= [41] Static Bool (False) output 0
...
- [40] Switch output 0 -> Lerp.A
- [45] Switch output 0 -> Lerp.B
...
- [44] Append output 0 -> Switch.A
- [36] Texture Sample output 0 -> Switch.B
- [42] Input Export Float 4 (StaticBool) output 0 -> Switch.Value
- [41] Static Bool (False) output 0 -> Input Export Float 4 (StaticBool).Preview
