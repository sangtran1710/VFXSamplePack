...
- `2` [FunctionInput_Vector2]
- `3` [FunctionInput_Vector2]
- `4` [FunctionInput_Vector2]
...
| 3 | function_input | `MaterialExpressionFunctionInput` | Input 1 (Vector2) | 1 |
| 4 | function_input | `MaterialExpressionFunctionInput` | Input 2 (Vector2) | 2 |
| 5 | function_input | `MaterialExpressionFunctionInput` | Input 3 (Vector2) | 3 |
| 6 | function_input | `MaterialExpressionFunctionInput` | Input 4 (Vector2) | 4 |
...
- `A` <= [3] Input 1 (Vector2) output 0
- `B` <= [4] Input 2 (Vector2) output 0
- `Alpha` <= [9] Clamp output 0

### [2] Lerp

- `A` <= [1] Lerp output 0
- `B` <= [5] Input 3 (Vector2) output 0
...
- [3] Input 1 (Vector2) output 0 -> Lerp.A
- [4] Input 2 (Vector2) output 0 -> Lerp.B
- [9] Clamp output 0 -> Lerp.Alpha
- [1] Lerp output 0 -> Lerp.A
- [5] Input 3 (Vector2) output 0 -> Lerp.B
...
- [6] Input 4 (Vector2) output 0 -> Lerp.B
