...
Structured visual-effect knowledge for the ForgePilot AI system.
The agent reads these files before executing visual-effect tasks to ensure correct timing, color, scale, and technique.
