...
| 14 | expression | `MaterialExpressionConstant` | 0 |  |
| 15 | expression | `MaterialExpressionGetMaterialAttributes` | GetMaterialAttributes |  |
| 16 | expression | `MaterialExpressionSetMaterialAttributes` | SetMaterialAttributes |  |

## Exact Input Wiring

### [0] Output Blended Material

- `A` <= [16] SetMaterialAttributes output 0

### [2] Lerp

- `A` <= [15] GetMaterialAttributes output 3
- `B` <= [6] Input DecalRoughness (Scalar) output 0
- `Alpha` <= [8] Texture Sample output 4

### [3] Lerp

- `A` <= [15] GetMaterialAttributes output 2
- `B` <= [5] 0 output 0
- `Alpha` <= [8] Texture Sample output 4

### [4] Lerp

- `A` <= [15] GetMaterialAttributes output 1
- `B` <= [8] Texture Sample output 0
- `Alpha` <= [8] Texture Sample output 4

### [8] Texture Sample

- `Coordinates` <= [9] TexCoord[1] output 0
...
- `A` <= [15] GetMaterialAttributes output 4
- `B` <= [13] 0,0,1 output 0
- `Alpha` <= [10] Multiply output 0

### [16] SetMaterialAttributes

- `Inputs[0]` <= [15] GetMaterialAttributes output 0
- `Inputs[1]` <= [4] Lerp output 0
- `Inputs[2]` <= [3] Lerp output 0
- `Inputs[3]` <= [2] Lerp output 0
- `Inputs[4]` <= [14] 0 output 0
- `Inputs[5]` <= [12] Lerp output 0
- `Inputs[6]` <= [14] 0 output 0
- `Inputs[7]` <= [14] 0 output 0

## Connection List

- [16] SetMaterialAttributes output 0 -> Output Blended Material.A
- [15] GetMaterialAttributes output 3 -> Lerp.A
- [6] Input DecalRoughness (Scalar) output 0 -> Lerp.B
- [8] Texture Sample output 4 -> Lerp.Alpha
- [15] GetMaterialAttributes output 2 -> Lerp.A
- [5] 0 output 0 -> Lerp.B
- [8] Texture Sample output 4 -> Lerp.Alpha
- [15] GetMaterialAttributes output 1 -> Lerp.A
- [8] Texture Sample output 0 -> Lerp.B
- [8] Texture Sample output 4 -> Lerp.Alpha
- [9] TexCoord[1] output 0 -> Texture Sample.Coordinates
...
- [15] GetMaterialAttributes output 4 -> Lerp.A
- [13] 0,0,1 output 0 -> Lerp.B
- [10] Multiply output 0 -> Lerp.Alpha
- [15] GetMaterialAttributes output 0 -> SetMaterialAttributes.Inputs[0]
...
- [14] 0 output 0 -> SetMaterialAttributes.Inputs[4]
- [12] Lerp output 0 -> SetMaterialAttributes.Inputs[5]
- [14] 0 output 0 -> SetMaterialAttributes.Inputs[6]
- [14] 0 output 0 -> SetMaterialAttributes.Inputs[7]

## Output Trace Roots

- `Blended Material` is driven by [16] SetMaterialAttributes
