...
- Category: Engine_MaterialFunctions02/NotInUse
...
| 103 | function_call | `MaterialExpressionMaterialFunctionCall` | WorldAlignedNormals_HighQuality_optimizationAttempt |  |
...
- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 3
- `B` <= [112] World Space to Tangent Space TransformVector output 0
- `Value` <= [56] Input World Space Normals (StaticBool) output 0

### [112] World Space to Tangent Space TransformVector

- `Input` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 3

### [113] Switch

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 2
- `B` <= [114] World Space to Tangent Space TransformVector output 0
- `Value` <= [56] Input World Space Normals (StaticBool) output 0

### [114] World Space to Tangent Space TransformVector

- `Input` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 2

### [115] Switch

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 1
- `B` <= [116] World Space to Tangent Space TransformVector output 0
- `Value` <= [56] Input World Space Normals (StaticBool) output 0

### [116] World Space to Tangent Space TransformVector

- `Input` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 1

### [117] Switch

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 0
- `B` <= [118] World Space to Tangent Space TransformVector output 0
- `Value` <= [56] Input World Space Normals (StaticBool) output 0

### [118] World Space to Tangent Space TransformVector

- `Input` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 0
...
### [139] Output Opti Normal - Custom UV 6

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 8

### [140] Output Opti Normal - Custom UV 5

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 7

### [141] Output Opti Normal - Custom UV 4

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 6

### [143] Input OptimizeHighQualityNormals (see comment) (StaticBool)

- `Preview` <= [144] Static Bool (False) output 0

### [145] Output Opti Normal - Custom UV 7

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 9

### [146] Output Opti Normal - Custom UV 3

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 5

### [147] Output Opti Normal - Custom UV 2

- `A` <= [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 4
...
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 3 -> Switch.A
- [112] World Space to Tangent Space TransformVector output 0 -> Switch.B
- [56] Input World Space Normals (StaticBool) output 0 -> Switch.Value
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 3 -> World Space to Tangent Space TransformVector.Input
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 2 -> Switch.A
- [114] World Space to Tangent Space TransformVector output 0 -> Switch.B
- [56] Input World Space Normals (StaticBool) output 0 -> Switch.Value
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 2 -> World Space to Tangent Space TransformVector.Input
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 1 -> Switch.A
- [116] World Space to Tangent Space TransformVector output 0 -> Switch.B
- [56] Input World Space Normals (StaticBool) output 0 -> Switch.Value
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 1 -> World Space to Tangent Space TransformVector.Input
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 0 -> Switch.A
- [118] World Space to Tangent Space TransformVector output 0 -> Switch.B
- [56] Input World Space Normals (StaticBool) output 0 -> Switch.Value
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 0 -> World Space to Tangent Space TransformVector.Input
...
- [132] Input PickTheDiffuseHeightChannel (StaticBool) output 0 -> Switch.Value
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 8 -> Output Opti Normal - Custom UV 6.A
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 7 -> Output Opti Normal - Custom UV 5.A
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 6 -> Output Opti Normal - Custom UV 4.A
- [144] Static Bool (False) output 0 -> Input OptimizeHighQualityNormals (see comment) (StaticBool).Preview
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 9 -> Output Opti Normal - Custom UV 7.A
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 5 -> Output Opti Normal - Custom UV 3.A
- [103] WorldAlignedNormals_HighQuality_optimizationAttempt output 4 -> Output Opti Normal - Custom UV 2.A
...
- `Opti Normal - Custom UV 6` is driven by [103] WorldAlignedNormals_HighQuality_optimizationAttempt
- `Opti Normal - Custom UV 5` is driven by [103] WorldAlignedNormals_HighQuality_optimizationAttempt
- `Opti Normal - Custom UV 4` is driven by [103] WorldAlignedNormals_HighQuality_optimizationAttempt
- `-------` has no captured source.
- `Opti Normal - Custom UV 7` is driven by [103] WorldAlignedNormals_HighQuality_optimizationAttempt
- `Opti Normal - Custom UV 3` is driven by [103] WorldAlignedNormals_HighQuality_optimizationAttempt
- `Opti Normal - Custom UV 2` is driven by [103] WorldAlignedNormals_HighQuality_optimizationAttempt
