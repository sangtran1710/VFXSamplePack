...
- `Ellipsoid Position` [FunctionInput_Vector3] - The Position of the Sphere in the World.
- `Ellipsoid XY size` [FunctionInput_Scalar] - The ellipsoid is always scaled along a local Z. The X and Y size need to be the same.
...
- `Ellipsoid Z Scale` [FunctionInput_Scalar] - This is used to scale a sphere into a ellipsoid. Scaling is always along the Ellipsoid's local Z axis.
- `Ellipsoid X Axis` [FunctionInput_Vector3] - Supply the axes of the ellipsoid transform in order to orient it correctly in the world.
- `Ellipsoid Y Axis` [FunctionInput_Vector3] - Supply the axes of the ellipsoid transform in order to orient it correctly in the world.
- `Ellipsoid Z Axis` [FunctionInput_Vector3] - Supply the axes of the ellipsoid transform in order to orient it correctly in the world.
- `Is Light Directional` [FunctionInput_StaticBool] - If the light is directional, the light vector will not have to be transformed into ellipsoid space which will save considerable instructions.
...
| 12 | function_input | `MaterialExpressionFunctionInput` | Input Ellipsoid Position (Vector3) | Ellipsoid Position |
| 13 | function_input | `MaterialExpressionFunctionInput` | Input Ellipsoid XY size (Scalar) | Ellipsoid XY size |
...
| 65 | expression | `MaterialExpressionMultiply` | Multiply |  |
| 66 | expression | `MaterialExpressionNormalize` | Normalize |  |
| 67 | expression | `MaterialExpressionConstant` | 0 |  |
| 68 | custom | `MaterialExpressionCustom` | acos(x) |  |
| 69 | custom | `MaterialExpressionCustom` | asin(x) |  |
| 70 | expression | `MaterialExpressionDivide` | Divide(,1.57) |  |
| 71 | expression | `MaterialExpressionDivide` | Divide(,3.14) |  |
| 72 | expression | `MaterialExpressionOneMinus` | 1-x |  |
| 73 | function_call | `MaterialExpressionMaterialFunctionCall` | InverseTransformMatrix |  |
| 74 | expression | `MaterialExpressionComponentMask` | Mask ( R G B ) |  |
| 75 | function_input | `MaterialExpressionFunctionInput` | Input Ellipsoid Z Scale (Scalar) | Ellipsoid Z Scale |
| 76 | expression | `MaterialExpressionAppendVector` | Append |  |
| 77 | expression | `MaterialExpressionConstant2Vector` | 1,1 |  |
| 78 | expression | `MaterialExpressionAppendVector` | Append |  |
| 79 | function_input | `MaterialExpressionFunctionInput` | Input Ellipsoid X Axis (Vector3) | Ellipsoid X Axis |
| 80 | function_input | `MaterialExpressionFunctionInput` | Input Ellipsoid Y Axis (Vector3) | Ellipsoid Y Axis |
| 81 | function_input | `MaterialExpressionFunctionInput` | Input Ellipsoid Z Axis (Vector3) | Ellipsoid Z Axis |
| 82 | function_call | `MaterialExpressionMaterialFunctionCall` | InverseTransformMatrix |  |
| 83 | function_input | `MaterialExpressionFunctionInput` | Input Is Light Directional (StaticBool) | Is Light Directional |
| 84 | expression | `MaterialExpressionStaticSwitch` | Switch |  |
| 85 | expression | `MaterialExpressionStaticBool` | Static Bool (False) |  |
...
- `A` <= [12] Input Ellipsoid Position (Vector3) output 0
- `B` <= [2] Absolute World Position output 0

### [4] Distance

- `A` <= [65] Multiply output 0
- `B` <= [67] 0 output 0

### [5] Normalize

- `VectorInput` <= [65] Multiply output 0
...
- `A` <= [13] Input Ellipsoid XY size (Scalar) output 0
...
- `A` <= [73] InverseTransformMatrix output 0
- `B` <= [76] Append output 0
...
- `A` <= [69] asin(x) output 0

### [71] Divide(,3.14)

- `A` <= [68] acos(x) output 0

### [72] 1-x

- `Input` <= [71] Divide(,3.14) output 0

### [76] Append

- `A` <= [77] 1,1 output 0
- `B` <= [75] Input Ellipsoid Z Scale (Scalar) output 0

### [78] Append

- `A` <= [72] 1-x output 0
- `B` <= [70] Divide(,1.57) output 0

### [83] Input Is Light Directional (StaticBool)

- `Preview` <= [85] Static Bool (False) output 0

### [84] Switch

- `A` <= [66] Normalize output 0
- `B` <= [82] InverseTransformMatrix output 0
- `Value` <= [83] Input Is Light Directional (StaticBool) output 0
...
- [12] Input Ellipsoid Position (Vector3) output 0 -> Subtract.A
- [2] Absolute World Position output 0 -> Subtract.B
- [65] Multiply output 0 -> Distance.A
- [67] 0 output 0 -> Distance.B
- [65] Multiply output 0 -> Normalize.VectorInput
- [44] ConstantBiasScale output 0 -> Append.A
- [9] Divide output 0 -> Append.B
- [84] Switch output 0 -> Dot.A
- [10] Multiply(,-1) output 0 -> Dot.B
- [6] Append output 0 -> Clamp.Input
- [13] Input Ellipsoid XY size (Scalar) output 0 -> Divide.A
...
- [13] Input Ellipsoid XY size (Scalar) output 0 -> If.A
...
- [62] Param (0) 'Min Texture Lightsource Angle' output 0 -> Subtract.B
- [73] InverseTransformMatrix output 0 -> Multiply.A
- [76] Append output 0 -> Multiply.B
- [11] Input Light Vector (Vector3) output 0 -> Normalize.VectorInput
- [69] asin(x) output 0 -> Divide(,1.57).A
- [68] acos(x) output 0 -> Divide(,3.14).A
- [71] Divide(,3.14) output 0 -> 1-x.Input
- [77] 1,1 output 0 -> Append.A
- [75] Input Ellipsoid Z Scale (Scalar) output 0 -> Append.B
- [72] 1-x output 0 -> Append.A
- [70] Divide(,1.57) output 0 -> Append.B
- [85] Static Bool (False) output 0 -> Input Is Light Directional (StaticBool).Preview
- [66] Normalize output 0 -> Switch.A
- [82] InverseTransformMatrix output 0 -> Switch.B
- [83] Input Is Light Directional (StaticBool) output 0 -> Switch.Value
