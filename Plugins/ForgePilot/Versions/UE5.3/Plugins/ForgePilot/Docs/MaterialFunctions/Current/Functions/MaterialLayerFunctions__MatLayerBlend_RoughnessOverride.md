...
| 4 | function_input | `MaterialExpressionFunctionInput` | Input NewRoughness (Vector3) | NewRoughness |
...
- `B` <= [4] Input NewRoughness (Vector3) output 0
...
- [4] Input NewRoughness (Vector3) output 0 -> Lerp.B
