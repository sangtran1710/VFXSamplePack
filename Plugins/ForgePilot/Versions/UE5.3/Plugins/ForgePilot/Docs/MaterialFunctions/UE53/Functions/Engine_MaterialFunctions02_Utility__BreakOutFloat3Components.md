...
Enter a float 3 vector into the function and retrieve individual channels back through the scalar outputs.
...
| 1 | function_input | `MaterialExpressionFunctionInput` | Input Float3 (Vector3) | Float3 |
...
| 5 | function_output | `MaterialExpressionFunctionOutput` | Output G | G |
| 6 | function_output | `MaterialExpressionFunctionOutput` | Output B | B |
...
- `Input` <= [1] Input Float3 (Vector3) output 0
...
- [1] Input Float3 (Vector3) output 0 -> Mask ( R ).Input
- [1] Input Float3 (Vector3) output 0 -> Mask ( G ).Input
- [1] Input Float3 (Vector3) output 0 -> Mask ( B ).Input
