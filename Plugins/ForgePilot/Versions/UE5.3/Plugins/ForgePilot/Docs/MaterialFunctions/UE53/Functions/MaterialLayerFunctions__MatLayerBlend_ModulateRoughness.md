...
Modulates the roughness value, useful for greasy look.

## Inputs

- `Base Material` [FunctionInput_MaterialAttributes]
- `RoughnessMultiplier` [FunctionInput_Scalar]
...
| 3 | function_input | `MaterialExpressionFunctionInput` | Input RoughnessMultiplier (Scalar) | RoughnessMultiplier |
...
- `B` <= [3] Input RoughnessMultiplier (Scalar) output 0
...
- [3] Input RoughnessMultiplier (Scalar) output 0 -> Multiply.B
