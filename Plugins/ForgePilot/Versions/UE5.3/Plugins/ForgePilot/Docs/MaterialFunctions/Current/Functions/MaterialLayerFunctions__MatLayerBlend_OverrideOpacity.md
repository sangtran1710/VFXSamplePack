...
| 4 | function_input | `MaterialExpressionFunctionInput` | Input NewOpacity (Scalar) | NewOpacity |
...
- `B` <= [4] Input NewOpacity (Scalar) output 0
...
- [4] Input NewOpacity (Scalar) output 0 -> Lerp.B
