...
- [9] Add output 0 -> Lerp.B
- [4] Input ScratchMask (Scalar) output 0 -> Lerp.Alpha
- [6] Lerp output 0 -> Lerp.A
- [8] Multiply output 0 -> Lerp.B
- [5] Input GrimeMask (Scalar) output 0 -> Lerp.Alpha
- [6] Lerp output 0 -> Multiply.A
- [3] Input GrimeValue (Vector3) output 0 -> Multiply.B
- [1] Input Base (Vector3) output 0 -> Add.A
- [2] Input ScratchValue (Vector3) output 0 -> Add.B
