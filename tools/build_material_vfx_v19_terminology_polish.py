...
OUT = Path.home() / "Downloads" / "Giao_Trinh_Material_VFX_Realtime_V19_TerminologyPolish.docx"
...
def cover(doc):
    ...
    p(doc, "Phiên bản V19 · Terminology Polish · 2026", size=9.3, font=SANS, color=MUTED, before=8, after=0, align=WD_ALIGN_PARAGRAPH.CENTER)
